...
Sprint Summary (Total: 4 Hours)

Sprint 1 (1 hr): Project setup, environment configuration, Tailwind & Vite setup

Sprint 2 (1 hr): UI structure implementation and layout matching with Figma

Sprint 3 (1 hr): Multi-step quiz functionality, navigation, answer handling

Sprint 4 (1 hr): Result screen logic, score animation, final UI polish & deployment
